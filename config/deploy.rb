...
set :application, 'StepStreak'
set :repo_url, 'git@github.com:StepStreak/StepStreak.git'
set :branch, 'main'
set :deploy_to, '/home/ubuntu/apps/stepstreak'
...
set :puma_service_unit_name, 'stepstreak-puma'
